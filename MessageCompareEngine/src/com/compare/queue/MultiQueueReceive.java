...
public class MultiQueueReceive implements MessageListener {
	...
	public MultiQueueReceive(Database database)
	{
	...
	private void sendAkkaServiceThe(String msgText, String corelationId) {
		com.compare.model.Message message = new com.compare.model.Message(UUIDGenerator.next(),msgText,corelationId, false,false);
		while(!jobService.isServiceStarted())
		{
			try {
	...
	public void close() throws JMSException {
		...
		//Stop job service
		jobService.shutDown();
		database.disconnect(schemaName);
	}
